...
LIST=['STUDY', 'FACTS', 'LIGHT', 'CHALK', 'ANGLE', 'BASIC', 'TEACH', 'BOARD','POUCH']
...
def wow():
    ...
    #        if chances!=0:
        ...
        if edit_label_1['text']==answer[0] and edit_label_2['text']==answer[1] and edit_label_3['text']==answer[2] and edit_label_4['text']==answer[3] and edit_label_5['text']==answer[4]:
            if ROUND<5:
                incriment()
    ...
    label03=Label(frame01,background='#FFFFFF', text='LEVEL 4', font=('arial','35'))
    ...
    label06=Label(frame03, bg='#142d39', fg='#FFFFFF', text='Guess a word that contains only 5 alphabets (education related words ONLY)', font=('arial','13'))
    ...
    edit_label_5.grid(row=1, column=6, padx=(5,30))



    sub_frame02=Frame(frame02, height=1,  width=100, bg='#000000').grid(row=1, column=7)
