...
pic01=PhotoImage(file='pic011.png')
label01=Label(back, image=pic01)
label01.pack(side='bottom')

label02=Label(frame01, text='Most Welcome!', font=('arial','35'))
label02.pack(pady=(50,15))

button01=Button(frame01, bg='#142d39', fg='#FFFFFF',  font=('aria','13') , text='How to play', width='35',height='2', command=instruction).pack(pady=(0,15))
button02=Button(frame01, bg='#142d39', fg='#FFFFFF', font=('aria','13') , text='Play', width='35',height='2', command=level_1)
